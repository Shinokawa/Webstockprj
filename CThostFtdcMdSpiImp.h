...
public:
    ...
    void ReqUserLogin()
    {
        ...
        strcpy_s(reqUserLogin.BrokerID, "您的BrokerID");
        strcpy_s(reqUserLogin.UserID, "您的UserID");
        strcpy_s(reqUserLogin.Password, "您的Password");
    ...
    void ReqUserLogout()
    {
        ...
        strcpy_s(reqLogout.BrokerID, "您的BrokerID");
        strcpy_s(reqLogout.UserID, "您的UserID");
